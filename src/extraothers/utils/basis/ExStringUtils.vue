...
public class ExStringUtils extends CharSequenceUtils {
     ...
     * @param s    每一个组合的输出
     */
    private static void getPermutation(StringBuilder out, String in, boolean[] used, ConsumerString> s) {
     ...
     * @param list 元素列表
     */
    public static T> ListListT>> getCombinations(ListT> list) {
        ListListT>> result = new ArrayList<>();
     ...
     * @param list 元素列表
     */
    public static T> ListListT>> getCombinations(T... list) {
        ListListT>> result = new ArrayList<>();
