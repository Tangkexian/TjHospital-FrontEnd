package com.javaee.onlinehosbackend.extraother.utils.chinese.chinesenumber;
 ...
 * 中文数字转化类
 */
public class CNumberN extends Number> extends Number implements ComparableCNumber> {
    ...
    /** 一个值 */
    public static N extends Number> CNumberN> ofNumber(String chineseStr, N num, BigDecimal realNum){
        return new CNumber<>(chineseStr, num, false, false, realNum);
    }

    /** 一个浮点值 */
    public static N extends Number> CNumberN> ofFloatNumber(String chineseStr, N num, BigDecimal realNum){
        return new CNumber<>(chineseStr, num, true, false, realNum);
    }

    /** 一个负数值 */
    public static N extends Number> CNumberN> ofNegativeNumber(String chineseStr, N num, BigDecimal realNum){
        return new CNumber<>(chineseStr, num, false, true, realNum);
    }

    /** 一个负数浮点值 */
    public static N extends Number> CNumberN> ofNegativeFloatNumber(String chineseStr, N num, BigDecimal realNum){
        return new CNumber<>(chineseStr, num, true, true, realNum);
    }
    /** 一个布尔值 */
    public static CNumberInteger> ofBooleanNumber(boolean booleanVal){
