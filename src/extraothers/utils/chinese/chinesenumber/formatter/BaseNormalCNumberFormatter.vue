package com.javaee.onlinehosbackend.extraother.utils.chinese.chinesenumber.formatter;

import java.math.BigDecimal;
import java.util.ArrayList;
import java.util.List;

import static com.javaee.onlinehosbackend.extraother.utils.chinese.chinesenumber.CNumberList.*;
 ...
 * @since JDK1.8
 **/
public abstract class BaseNormalCNumberFormatterN extends Number> extends BaseCNumberFormatterN> {
...
//    }
    ...
    protected BigDecimal baseParse(String[] arr) {
        //总值集合
        ListBigDecimal> numbers = new ArrayList<>();
        //总值
