...
import com.javaee.onlinehosbackend.extraother.utils.chinese.chinesenumber.CNumberList;
 ...
 * @since JDK1.8
 **/
public abstract class BaseCNumberFormatterN extends Number> implements CNumberFormatterN>, CNumberList {
