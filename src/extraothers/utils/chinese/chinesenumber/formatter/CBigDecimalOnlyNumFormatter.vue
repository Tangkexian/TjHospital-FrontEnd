...
import com.javaee.onlinehosbackend.extraother.utils.chinese.chinesenumber.CNumber;
 ...
 * @since JDK1.8
 **/
public class CBigDecimalOnlyNumFormatter extends BaseOnlyNumCNumberFormatterBigDecimal> {
