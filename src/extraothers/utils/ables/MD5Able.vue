package com.javaee.onlinehosbackend.extraother.utils.ables;

import com.javaee.onlinehosbackend.extraother.utils.function.ExFunction;
import com.javaee.onlinehosbackend.extraother.utils.function.FunctionThrows;
import com.javaee.onlinehosbackend.extraother.utils.security.MD5Utils;
...
public interface MD5Able extends StringAble {
     ...
     * @return
     */
    default String toMD5(String salt, ExFunctionFunctionThrowsString, String>, String, String, String> saltFunction) {
        return saltFunction.apply(MD5Utils::toMD5, toStr(), salt);
    }
    default String toMD5(String salt, Charset charset, ExFunctionFunctionThrowsString, String>, String, String, String> saltFunction) {
        return saltFunction.apply(MD5Utils::toMD5, toStr(charset), salt);
    }
    default String toMD5(String salt, String charsetName, ExFunctionFunctionThrowsString, String>, String, String, String> saltFunction) throws UnsupportedEncodingException {
