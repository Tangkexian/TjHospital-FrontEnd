...
public class HexUtils {
    ...
    public static Integer hexString2Integer(String hexString) {
        if (hexString == null || hexString.equals("") || hexString.equalsIgnoreCase("0x")) {
            return null;
        }
        if (hexString.startsWith("0x") || hexString.startsWith("0X")) {
    ...
    public static String int2HexString(int n) {
        return int2HexString(n, 4, false);
    }

    public static String int2HexStringWithPrefix(int n) {
        return int2HexString(n, 4, true);
    }

    public static String int2HexString(int n, int strLength) {
        return int2HexString(n, strLength, false);
    }

    public static String int2HexStringWithPrefix(int n, int strLength) {
        return int2HexString(n, strLength, true);
    }

    public static String int2HexString(int n, int strLength, boolean withPrefix) {
        StringBuilder sb = new StringBuilder(Integer.toHexString(n).toUpperCase());
